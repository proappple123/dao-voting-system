...
var Certificate = class _Certificate {
  ...
  static async create(options) {
    ...
    const cert = new _Certificate(options.certificate, options.rootKey, options.canisterId, blsVerify2);
    await cert.verify();
    return cert;
  }
  lookup(path) {
  ...
  async _checkDelegationAndGetKey(d) {
    ...
    const cert = await _Certificate.create({
...
buffer/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-GSOP6H4T.js.map
